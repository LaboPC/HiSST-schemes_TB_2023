...
# Change Locus name
LOCUS_HiSST <- "yvoA" # locus name (e.g., "glnG")
...
FWD = "CCGAGAGCGGCATGATCGA"
REV = "CAGGCARCGCATCGCCA"
...
# truncLen values for Forward and Reverse reads :  "197 150" for yvoA
# Expected Amplicon size = 197 for yvoA