...
# Change Locus name
LOCUS_HiSST <- "ribA" # locus name (e.g., "glnG")
...
FWD = "CTGCCCTCGYTGGGCTA"
REV = "GACGATGATCGCSACCTGG"
...
# truncLen values for Forward and Reverse reads :  "200 125" for ribA
# Expected Amplicon size = 291 for ribA