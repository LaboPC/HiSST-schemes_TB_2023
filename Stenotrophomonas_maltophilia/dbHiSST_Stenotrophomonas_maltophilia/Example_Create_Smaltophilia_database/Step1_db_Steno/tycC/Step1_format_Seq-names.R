setwd("~/Example_Create_Smaltophilia_database/Step1_db_Steno/tycC") # Change to your working directory file
LOCUS = "tycC" # Change "LOCUS" to the corresponding HiSST locus
...
new_names.[15] <- "Stenotrophomonas maltophilia WP1-W18-CRE-01"
