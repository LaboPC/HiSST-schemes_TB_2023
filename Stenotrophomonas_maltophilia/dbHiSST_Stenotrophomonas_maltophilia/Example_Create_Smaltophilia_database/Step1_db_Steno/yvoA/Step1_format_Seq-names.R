setwd("~/Example_Create_Smaltophilia_database/Step1_db_Steno/yvoA") # Change to your working directory file
LOCUS = "yvoA" # Change "LOCUS" to the corresponding HiSST locus
...
new_names.[49] <- "Stenotrophomonas maltophilia WP1-W18-CRE-01"
