...
setwd("~/Example_Create_Smaltophilia_database/Step3_Keep_unique-SST")

HiSST_locus <- c("glnG","ribA", "tycC", "yvoA")
input_files <- paste("~/Example_Create_Smaltophilia_database/Step2_keep_redond_loci/HiSST_",
