...
setwd("~/Step2_keep_redond_loci/") # Change to your wriking directory file

# Define file paths and locus names
PATH.LOCUS <- "~/Example_Create_Smaltophilia_database/Step1_db_Steno/"
locus_names <- c("yvoA", "glnG", "tycC", "ribA")
