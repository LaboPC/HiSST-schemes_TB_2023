...
loci <- c("btuB", "bvgS", "pheT", "sdaA")
# Change the path file
file_path <- "~/Example_Create_Paeruginosa_database/"
...
write.table(HiSST.profiles, file = "new_version_HiSSTprofiles-Pa.txt", sep = "\t", row.names = FALSE, quote = FALSE)
