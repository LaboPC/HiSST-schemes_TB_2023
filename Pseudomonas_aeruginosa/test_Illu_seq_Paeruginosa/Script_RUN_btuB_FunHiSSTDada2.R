...
# Change Locus name
LOCUS_HiSST <- "btuB" # locus name (e.g., "bvgS")
...
FWD <-  "GCCAAGCCGTTCTTCTCCG" # (e.g., "ACGGCGACGARCTGTTGC" for bvgS)
REV <-  "CAGGTTCTGCTCGCCGTC" # (e.g., "GGCATGGTCGGCGTAACC" for bvgS)
...
# truncLen values for Forward and Reverse reads : "95 220" 
# expected amplicon size whithout primers : 290
