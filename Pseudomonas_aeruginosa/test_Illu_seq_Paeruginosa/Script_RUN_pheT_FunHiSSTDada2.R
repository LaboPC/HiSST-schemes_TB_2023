...
# Change Locus name
LOCUS_HiSST <- "pheT" # locus name (e.g., "bvgS")
...
FWD = "GCGTGGACTTCTTCGACGC" # (e.g., "ACGGCGACGARCTGTTGC" for bvgS)
REV = "GACAGCTCGCGGAACTTCG" # (e.g., "GGCATGGTCGGCGTAACC" for bvgS)
...
# truncLen values for Forward and Reverse reads : "180 150" 
# expected amplicon size whithout primers : 233
