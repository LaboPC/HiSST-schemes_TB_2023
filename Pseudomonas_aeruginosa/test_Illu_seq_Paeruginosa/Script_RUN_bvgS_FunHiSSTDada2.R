...
# Change Locus name
LOCUS_HiSST <- "bvgS" # locus name (e.g., "bvgS")
...
REV <-  "GGCATGGTCGGCGTAACC" # (e.g., "GGCATGGTCGGCGTAACC" for bvgS)
...
# truncLen values for Forward and Reverse reads : "210 160" 
# expected amplicon size whithout primers : 274
